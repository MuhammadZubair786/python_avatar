...
class Routine19Screen extends StatefulWidget {
  const Routine19Screen({Key? key}) : super(key: key);

  @override
  State<Routine19Screen> createState() => _Routine19ScreenState();
}

class _Routine19ScreenState extends State<Routine19Screen> {
  bool timezone = false;
